...
import Container from '@/assets/images/Container11.png'
...
const SpecialServices: React.FC = () => {
  ...
  return (
    <div className="w-[320px] bg-dunkel rounded-4xl flex flex-row justify-between  p-6 h-[127px] mb-10 mt-8">
      <div className="flex flex-row justify-center items-center gap-2 mr-2">
        <div className="flex flex-col items-center">
          <div
            className="bg-transparent border-[0.5px] border-secondary-300/60 rounded-md p-4 flex items-center justify-center w-[58.59px] h-[58.59px] cursor-pointer transition-transform duration-200 ease-out hover:scale-105"
      ...
      {/*<div className="bg-secondary-100 rounded-4xl flex flex-col items-center w-[96px] h-[143px] -ml-3 -mt-5">
        ...
        <button
          onClick={() => navigate('/UnderUpdatePage')}
          className="bg-dunkel text-secondary-100 rounded-full w-[66px] h-[18px] text-[8px] whitespace-nowrap cursor-pointer mt-6"
        >
          دریافت مشاوره
        </button>
      </div>*/}
