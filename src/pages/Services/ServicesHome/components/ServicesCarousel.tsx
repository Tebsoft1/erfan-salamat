      ...
      <div className="flex items-center gap-2">
        ...
        >
          {services.map((service, idx) => (
            ...
            >
              <div className="bg-transparent border-[0.3px] border-[0.5px] border-secondary-300/60 rounded-md p-4 flex items-center justify-center w-[58.59px] h-[58.59px] transition-transform duration-200 ease-out hover:scale-105">
                <img
                  src={service.img}
                  alt={service.label}
