  ...
  return (
    ...
    if (e.key === 'Enter') {
      searchHandler();
          ...
          className="w-full text-[10px] p-3 pr-4 pl-10 rounded-full bg-dunkel text-secondary-100 placeholder-secondary-900 border-r-3 border-r-primary-300 focus:outline-none"
        />
      </div>
