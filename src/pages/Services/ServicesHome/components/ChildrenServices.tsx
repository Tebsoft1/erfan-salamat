...
import ChildImg from '@/assets/images/BabyImgNew.png'
...
const ChildrenServices: React.FC = () => {
  ...
  return (
    <div className="relative w-full bg-dunkel rounded-4xl flex flex-row items-stretch p-3 h-[139px] mt-10 mb-5">
      ...
      <div className="flex flex-row justify-center items-center flex-1 gap-4 ml-2">
        <div className="flex flex-col w-[58.59px] h-[58.59px] cursor-pointer transition-transform duration-200 ease-out hover:scale-105">
          <div
            ...
            className="border-[0.3px] border-secondary-300/60 rounded-xl p-4 flex items-center justify-center"
          >
      ...
      <img src={ChildImg} alt="+" className="w-[113px] h-[163px] -ml-3 -mt-8" />
    </div>
  )
}
